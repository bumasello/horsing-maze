...
const horseRapiModel_1 = __importDefault(require("./horseRapiModel"));
const RaceCard_Api = new mongoose_1.default.Schema({
    ...
    runners: [horseRapiModel_1.default.HorseSchema],
});
exports.default = mongoose_1.default.model("RaceCard_API", RaceCard_Api);
/*
 {
            "course": "Ascot",
            "date": "2025-03-30",

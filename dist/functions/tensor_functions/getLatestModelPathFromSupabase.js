...
exports.getLatestModelPathFromSupabase_v3 = getLatestModelPathFromSupabase_v3;
const __1 = require("../..");
...
function getLatestModelPathFromSupabase_v3() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (data && data.length > 0) {
            console.log("Itens encontrados no bucket:", data.map((item) => item.name));
            ...
            if (versionFolders.length > 0) {
                console.log("Pastas de versão encontradas:", versionFolders.map((item) => item.name));
                ...
                console.log(`Caminho do modelo mais recente encontrado: ${modelJsonPath}`);

...
const horseModel_1 = __importDefault(require("./horseModel"));
const RaceCard = new mongoose_1.default.Schema({
    ...
    runners: [horseModel_1.default.HorseSchema],
});
exports.default = mongoose_1.default.model("RaceCard", RaceCard);
/*
 {
            "course": "Ascot",
            "date": "2025-03-30",
